        ...
        var intro = function(){
         ...
         var demarrerStory = function(){
                ...
                mainstory
                        ...
                        .story('Not tested on IE, sorry',{callback:function(){creatingDev()}})
                        .story('Hey wait a minute')
                        .story('Something strange append here.')
                        .story('Why is this not loading?')
                        .story('What’s happening?')
                        .story('There’s some lights over there. Can’t see anything!!!!!',{callback:function(){
                                $('#mainstory').empty();                               
                        }})                     
        }
        
        var creatingDev = function(){
                var dev = $('#game').playerDev();
                dev.fall();
